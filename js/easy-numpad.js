$(document).ready(function () {
    ...
    $('#multi-btn').click(function(){
        ...
        $('#price').removeClass('activate')
        $('#quantity').addClass('input-num')
        $('#price-p').removeClass('input-num');

        $('.quantity').addClass('d-none')
    })
    $('#price').click(function(){
        $(this).addClass('activate');
        $('#multi-btn').removeClass('activate');
        $('#quantity').removeClass('input-num')
        $('#price-p').addClass('input-num');
...
function easynum() {
    ...
    console.log(easy_num_value)
    $('.input-num').append(easy_num_value);

    
}
function easy_numpad_del() {
    event.preventDefault();
    var easy_numpad_output_val = $('.input-num').text();
    var easy_numpad_output_val_deleted = easy_numpad_output_val.slice(0, -1);
    $('.input-num').text(easy_numpad_output_val_deleted);
